...
- **Docker Desktop / Docker Engine** — hosts the PostgreSQL + pgvector container.
  Download from <https://www.docker.com/products/docker-desktop>.
- **Node.js 20.x** (LTS) — powers the Next.js application and Prisma CLI.
  Download from <https://nodejs.org> or install via `nvm install 20`.
...
2. **Prepare the environment**
   ...
   | `DEEPSEEK_API_KEY` | your DeepSeek API key (for Ask AI Q&A) |
...
3. Sends the paper context to DeepSeek V4 Flash to generate a grounded answer
